...
function showLoading() {
	...
	setTimeout(() => {
		// REMOVE LOADING ANIMATION AFTER 1S
		loading.classList.remove('show');
		
		setTimeout(() => {
			// CREATE NEW POST AFTER A LITTLE WHILE ( WAIT FOR THE LOADING TO DISSAPPEAR)
			createPost();
		}, 300);
	}, 1000);
}
...
function createPost() {
	...
	post.innerHTML = `
		<img src="https://source.unsplash.com/random/150x200" alt="" />
			<div class="post-info">
